...
public class UpdateDeletePatient extends javax.swing.JFrame {
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        dbconn   = new DatabaseConnector();
          arrayList =  dbconn.SearchQuery(searchField.getText());
        UpdatePatient up = new UpdatePatient(arrayList);
        
        up.setVisible(true);
        }catch(Exception e){
        
            Logger.getLogger(UpdateDeletePatient.class.getName()).log(Level.SEVERE, null, e);
        }
    ...
    private void deletePatientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletePatientActionPerformed
        try {
            // TODO add your handling code here:
        dbconn   = new DatabaseConnector();
            dbconn.DeleteQuery(searchField.getText());
